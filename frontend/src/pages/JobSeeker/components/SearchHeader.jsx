...
const SearchHeader = ({ filters, handleFilterChange }) => {
  ...
  return (
    <div
      ...
      } backdrop-blur-xl rounded-2xl p-4 lg:p-8 mb-6 lg:mb-8`}
    >
        ...
        <div className="flex flex-col lg:flex-row gap-3 lg:gap-4">
          <div className="flex-1 relative">
            ...
            <input
              ...
              }  rounded-xl lg:rounded-xl outline-0 text-basebackdrop-blur-sm`}
          ...
          <button
            ...
            } px-6 lg:px-10 py-3 lg:py-2.5 rounded-xl lg:rounded-xl transition-all duration-300 font-semibold text-base shadow-lg hover:shadow-xl transform hover:-translate-y-0.5`}
          >
            Search Jobs
          </button>
        </div>
