            ...
            <div className="relative bg-white px-0 pb-8 mt-8 border-b border-gray-100">
              <div className="relative z-10">
                ...
                <div className="flex flex-wrap gap-3 mt-6 md:mt-4">
                  <span className="px-4 py-2 bg-purple-100 text-sm text-purple-700 font-semibold rounded-full border border-purple-200">
                    {
                ...
                <div className="relative z-10">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <h3 className="text-sm font-semibold txet-gray-900 mb-1">
                          Compensation
                        </h3>
